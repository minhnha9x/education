<div id="taModal" class="modal admin-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document" style="width: 650px">
        <div class="modal-content">
            <div class="main-agileits">
                <div class="form-w3-agile clearfix">
                    <form role="form" class="clearfix" ng-submit="addTA(editTA)">
                        <h2 id="form-title"><% button %></h2>
                        <div class="form-sub-w3 col-md-6">
                            <select ng-model="taNameSelected" ng-show="showSelect" ng-required="showSelect">
                                <option value="" selected disabled hidden>Tên trợ giảng</option>
                                <option ng-repeat="x in listEmployeeInfo" value="<% x.id %>"><% x.name %> (<% x.mail %>)</option>
                            </select>
                            <input type="text" ng-model="taName" disabled ng-show="!showSelect">
                        </div>
                        <div class="form-sub-w3 col-md-6">
                            <input type="text" placeholder="Bằng cấp" ng-model="taDegree" required>
                        </div>
